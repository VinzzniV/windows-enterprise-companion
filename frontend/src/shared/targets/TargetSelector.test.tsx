...
const searchResult: AdComputerSearchResult = {
  ...
  truncated: false,
  computers: [
    { name: 'PC1', dnsHostName: 'pc1.kauth.local', operatingSystem: 'Windows 11 Pro', enabled: true },
    { name: 'PC2', dnsHostName: 'pc2.kauth.local', operatingSystem: null, enabled: true },
    { name: 'OLD1', dnsHostName: 'old1.kauth.local', operatingSystem: null, enabled: false },
  ],
};
