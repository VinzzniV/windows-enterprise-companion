...
export const appRoutes: readonly AppRouteDefinition[] = [
  ...
  { id: 'clients', path: '/clients', sectionLabel: 'Clients', Component: ClientsPage, navigation: { group: 'fleet', label: 'Clients', icon: navIcons.clients, searchTerms: ['devices', 'fleet', 'computers', 'kaspersky', 'ksc'] } },
  ...
  { id: 'vulnerabilities', path: '/vulnerabilities', sectionLabel: 'Nessus vulnerabilities', Component: VulnerabilitiesPage, navigation: { group: 'fleet', label: 'Nessus vulnerabilities', icon: navIcons.vulnerabilities, searchTerms: ['nessus', 'findings', 'cve'] } },
  { id: 'patch-management', path: '/patchmanagement', sectionLabel: 'opsi & Winget', Component: PatchManagementPage, navigation: { group: 'fleet', label: 'opsi & Winget', icon: navIcons.patchmanagement, searchTerms: ['opsi', 'winget', 'updates', 'packages'] } },
  ...
  { id: 'reporting', path: '/reporting', sectionLabel: 'Local report export', Component: ReportingPage, navigation: { group: 'fleet', label: 'Local report export', icon: navIcons.reporting, searchTerms: ['reports', 'html', 'json', 'this computer'] } },
  { id: 'settings', path: '/settings', sectionLabel: 'Settings', Component: SettingsPage, navigation: { group: 'administration', label: 'Settings', icon: navIcons.settings, searchTerms: ['configuration', 'connections', 'kaspersky', 'ksc', 'opsi', 'nessus'] } },
