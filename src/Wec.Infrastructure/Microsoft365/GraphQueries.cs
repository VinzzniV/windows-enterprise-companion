...
internal static class GraphQueries
{
    ...
    internal static string Path(Microsoft365Query query, int pageSize)
    {
        ...
        return query.Resource switch
        {
            ...
            Microsoft365Resource.ManagedDevices => "deviceManagement/managedDevices?$select=id,deviceName,userId,userPrincipalName,operatingSystem,osVersion,complianceState,managementState,deviceEnrollmentType,lastSyncDateTime,manufacturer,model,serialNumber,azureADDeviceId" + page,
