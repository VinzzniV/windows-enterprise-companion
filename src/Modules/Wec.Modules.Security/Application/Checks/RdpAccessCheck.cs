...
internal sealed class RdpAccessCheck : ISecurityCheck
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        Result<object?> denyConnections = await _registryReader.ReadLocalMachineValueAsync(
            context.Target, context.Credentials, context.Connection, TerminalServerKey, DenyConnectionsValue, cancellationToken);
